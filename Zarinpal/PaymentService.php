...
namespace App\Http\Services\Zarinpal;
...
class PaymentService
{
    ...
    public function __construct($MID,$amount,$sandbox,$callback)
    {
        $this->MID = $MID;
        $this->amount = $amount;
    ...
    public function zarinpalVerify()
    {
        ...
        $data = ['merchent_id' => $this->MID, 'authority' => $authority, 'amount' => $this->amount * 10];
